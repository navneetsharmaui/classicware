...
class Auth
{
  ...
  public function requireLogin()
  {
    if ( ! $this->isLoggedIn()) {
      ...
      Util::redirect('/sandbox/ecommerce/New_folder/login.php');
    }
  }
  ...
  {
    if ($this->isLoggedIn()) {
      Util::redirect('/sandbox/ecommerce/New_folder/index.php');
    }
  }
  ...
  public function sendPasswordReset($email)
  {
    ...
    if ($user !== null) {
      ...
      if ($user->startPasswordReset()) {
        ...
        $url = 'http://'.$_SERVER['HTTP_HOST'].'/sandbox/ecommerce/New_folder/reset_password.php?token=' . $user->password_reset_token;
